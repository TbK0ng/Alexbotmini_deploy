        ...
        try:
            while True:
                ...
                if count_lowlevel % 10 == 0:
                    ...
                    self.timesteps.append(self.count)
                    self.count += 1
            ...
            plt.plot(self.timesteps, self.pitch_data, label='Pitch')
            plt.plot(self.timesteps, self.roll_data, label='Roll')
            plt.plot(self.timesteps, self.yaw_data, label='Yaw')
            plt.xlabel('Timestep')
            plt.ylabel('Angle (deg)')
            plt.title('IMU Pitch, Roll, Yaw Angles')
            plt.legend()
            plt.grid(True)
            plt.show()
